...
GType      dex_delayed_get_type   (void);
DEX_AVAILABLE_IN_ALL
DexFuture *dex_delayed_new        (DexFuture  *future) G_GNUC_WARN_UNUSED_RESULT;
DEX_AVAILABLE_IN_ALL
void       dex_delayed_release    (DexDelayed *delayed);
DEX_AVAILABLE_IN_ALL
DexFuture *dex_delayed_dup_future (DexDelayed *delayed) G_GNUC_WARN_UNUSED_RESULT;
